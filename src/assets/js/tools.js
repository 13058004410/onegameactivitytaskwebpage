...
export function reverseStrings (strs) {
  return strs
    .split('')
    .sort()
    .reverse()
...
export function toLogin() {
  ...
  Vue.prototype.$toastMessage({ message: '请登录账号', time: 3000 })
}
/**
...
//获取昨天的日期
export function getYestodayDate () {
  var yestodayDate = new Date(nowYear, nowMonth, nowDay-1);
  return formatDate(yestodayDate);
}
