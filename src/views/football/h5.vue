  ...
  <div class="app-view">
    ...
    <div class="box-info">
      ...
      <div v-else class="no-data">
        <img src="../../assets/img/football/h5/qslogoh5.png" alt="">
      </div>
      </div>
      <div class="box-table">
        <table>
      ...
      <div class="btn-kf" @click="jumpKefuNative"></div>
      <div class="hd-gz"></div>
    </div>
    <div class="box-rule">
      <div class="box-cont">
        ...
        <p>
          3.此活动计算单场赛事沙巴体育+BTI体育符合要求的累计投注额。计算两个场馆投注额之和做一次派奖。
        </p>
        <p>
          4.本活动及彩金仅限BTI体育厅和沙巴体育厅，仅需一倍体育场馆流水即可提款。
        </p>
        <p>
          5.本活动与洗码优惠共享，不与其他任意优惠活动共享。
        </p>
        <p>
