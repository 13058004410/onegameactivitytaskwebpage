  ...
  <div class="bti-free-bets-h5">
    ...
    <div class="activities-title-one">
      <van-image
        width="131px"
        height="25px"
        :src="require('./img/H5/hdnr_tit.png')"
      />
      <p>
      ...
      <dl>
        <div>
          <dt class="maxHeight">单日体育场馆<br />有效投注额</dt>
          <dt class="maxHeight">免费投注</dt>
          <dt class="maxHeight">可使用赛事</dt>
        </div>
        <div>
          <dd class="maxHeight">≥3888CNY <br />/556USDT</dd>
          <dd class="maxHeight">38CNY</dd>
          <dd class="maxHeight">足球、篮球</dd>
        </div>
      </dl>
      <p>
    ...
    <div class="activities-title-two">
      <van-image
        width="131px"
        height="25px"
        :src="require('./img/H5/hdgz_tit.png')"
      />
      <p>
