    ...
    <div :class="[{'this-week-box': activeInd == 1}, {'un-login': !loginStatus}, 'item-box discount-box']" >
      ...
      <div class="content_wrapper" v-if="loginStatus">
        ...
        <div class="last-week" v-if="activeInd == 0">
          ...
          <div @click="openModal(0)"><span><img class="eachDayBetAmount" :src="require('@/assets/img/washCode_1/btn_pc.png')" alt=""></span></div>
        </div>
        <!-- 今天----------------------------------------------- -->
        <div class="this-week" v-else>
          ...
          <div @click="openModal(1)"><span><img class="eachDayBetAmount" :src="require('@/assets/img/washCode_1/btn_pc.png')" alt=""></span></div>
        </div>
      </div>
    </div>
  ...
  watch:{
    h5TokenStore: {
        handler:function( newValue ){
            ...
            let that = this;
            if(newValue.loginName && newValue.token){
                that.getCreateRequest();
                that.loadWashCodeList()
            }
        },
        deep:true
    }
